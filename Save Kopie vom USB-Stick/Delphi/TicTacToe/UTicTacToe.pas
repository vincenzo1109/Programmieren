...
type
  TForm1 = class(TForm)
    ...
    procedure Setzemensch(index: integer);
    ...
    procedure PanelTopMiddleClick(Sender: TObject);
    procedure PanelTopRightClick(Sender: TObject);
    procedure PanelMiddleLeftClick(Sender: TObject);
    procedure PanelMiddleMiddleClick(Sender: TObject);
    procedure PanelMiddleRightClick(Sender: TObject);
    procedure PanelBottomLeftClick(Sender: TObject);
    procedure PanelBottomMiddleClick(Sender: TObject);
    procedure PanelBottomRightClick(Sender: TObject);
  private
...
procedure TForm1.PanelTopMiddleClick(Sender: TObject);
begin
  Setzemensch(2);
end;


procedure TForm1.PanelTopRightClick(Sender: TObject);
begin
  Setzemensch(3);
end;


procedure TForm1.PanelMiddleLeftClick(Sender: TObject);
begin
  Setzemensch(4);
end;


procedure TForm1.PanelMiddleMiddleClick(Sender: TObject);
begin
  Setzemensch(5);
end;


procedure TForm1.PanelMiddleRightClick(Sender: TObject);
begin
  Setzemensch(6);
end;


procedure TForm1.PanelBottomLeftClick(Sender: TObject);
begin
  Setzemensch(7);
end;


procedure TForm1.PanelBottomMiddleClick(Sender: TObject);
begin
  Setzemensch(8);
end;


procedure TForm1.PanelBottomRightClick(Sender: TObject);
begin
  Setzemensch(9);
end;


procedure TForm1.Setzemensch(index: integer);
begin
  if fieldShow[index] = ' ' then
  begin
    a := a + 1;
    if a mod 2 = 1 then
      fieldShow[index] := 'X'
